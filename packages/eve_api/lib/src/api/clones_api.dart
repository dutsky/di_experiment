...
import 'package:openapi/src/model/get_characters_character_id_clones_ok.dart';
...
class ClonesApi {
  ...
  const ClonesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetCharactersCharacterIdClonesOk] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetCharactersCharacterIdClonesOk>> getCharactersCharacterIdClones({ 
    ...
    final _path = r'/characters/{character_id}/clones/'.replaceAll('{' r'character_id' '}', characterId.toString());
    ...
    GetCharactersCharacterIdClonesOk _responseData;

    try {
      const _responseType = FullType(GetCharactersCharacterIdClonesOk);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetCharactersCharacterIdClonesOk;
    ...
    return Response<GetCharactersCharacterIdClonesOk>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<int>>> getCharactersCharacterIdImplants({ 
    required int characterId,
    String? datasource = 'tranquility',
    String? ifNoneMatch,
    String? token,
    ...
    final _path = r'/characters/{character_id}/implants/'.replaceAll('{' r'character_id' '}', characterId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (ifNoneMatch != null) r'If-None-Match': ifNoneMatch,
