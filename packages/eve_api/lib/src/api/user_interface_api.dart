...
import 'package:openapi/src/model/post_ui_openwindow_newmail_new_mail.dart';
import 'package:openapi/src/model/post_ui_openwindow_newmail_unprocessable_entity.dart';
...
class UserInterfaceApi {
  ...
  const UserInterfaceApi(this._dio, this._serializers);
  ...
  Future<Response<void>> postUiAutopilotWaypoint({ 
    ...
    final _path = r'/ui/autopilot/waypoint/';
    ...
    final _queryParameters = <String, dynamic>{
      r'add_to_beginning': encodeQueryParameter(_serializers, addToBeginning, const FullType(bool)),
      r'clear_other_waypoints': encodeQueryParameter(_serializers, clearOtherWaypoints, const FullType(bool)),
      if (datasource != null) r'datasource': encodeQueryParameter(_serializers, datasource, const FullType(String)),
      r'destination_id': encodeQueryParameter(_serializers, destinationId, const FullType(int)),
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> postUiOpenwindowContract({ 
    ...
    final _path = r'/ui/openwindow/contract/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'contract_id': encodeQueryParameter(_serializers, contractId, const FullType(int)),
      if (datasource != null) r'datasource': encodeQueryParameter(_serializers, datasource, const FullType(String)),
      if (token != null) r'token': encodeQueryParameter(_serializers, token, const FullType(String)),
    };
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> postUiOpenwindowInformation({ 
    ...
    final _path = r'/ui/openwindow/information/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (datasource != null) r'datasource': encodeQueryParameter(_serializers, datasource, const FullType(String)),
      r'target_id': encodeQueryParameter(_serializers, targetId, const FullType(int)),
      if (token != null) r'token': encodeQueryParameter(_serializers, token, const FullType(String)),
    };
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> postUiOpenwindowMarketdetails({ 
    required int typeId,
    String? datasource = 'tranquility',
    String? token,
    CancelToken? cancelToken,
    ...
    final _path = r'/ui/openwindow/marketdetails/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [newMail] - The details of mail to create
  /// * [datasource] - The server name you would like data from
  /// * [token] - Access token to use if unable to set a header
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> postUiOpenwindowNewmail({ 
    required PostUiOpenwindowNewmailNewMail newMail,
    String? datasource = 'tranquility',
    String? token,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/ui/openwindow/newmail/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PostUiOpenwindowNewmailNewMail);
      _bodyData = _serializers.serialize(newMail, specifiedType: _type);
