...
// tests for GetCharactersCharacterIdContractsContractIdItems200Ok
void main() {
  final instance = GetCharactersCharacterIdContractsContractIdItems200OkBuilder();
  // TODO add properties to the builder and call build()

  group(GetCharactersCharacterIdContractsContractIdItems200Ok, () {
