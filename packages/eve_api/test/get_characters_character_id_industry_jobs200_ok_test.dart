...
// tests for GetCharactersCharacterIdIndustryJobs200Ok
void main() {
  final instance = GetCharactersCharacterIdIndustryJobs200OkBuilder();
  // TODO add properties to the builder and call build()

  group(GetCharactersCharacterIdIndustryJobs200Ok, () {
    // Job activity ID
    // int activityId
