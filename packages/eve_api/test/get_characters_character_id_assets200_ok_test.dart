...
// tests for GetCharactersCharacterIdAssets200Ok
void main() {
  final instance = GetCharactersCharacterIdAssets200OkBuilder();
  // TODO add properties to the builder and call build()

  group(GetCharactersCharacterIdAssets200Ok, () {
    // is_blueprint_copy boolean
    // bool isBlueprintCopy
    test('to test the property `isBlueprintCopy`', () async {
      // TODO
    });
